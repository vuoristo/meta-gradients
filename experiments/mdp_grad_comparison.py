...
if __name__ == '__main__':
    config = {
        ...
        'inner_loss': 'no_is',
        'outer_loss': tune.grid_search(['first_state', 'first_state_adv']),
        'truncation_length': 8,
        'meta_lambda': 1.0,
        'auc_loss': True,
        'vf_coef': 0.1,
        ...
        'train_step': tune.grid_search(['mg', 'fd']),
        'fd_epsilon': 0.1,
        'save_gradients': True,
    ...
    analysis = tune.run(
        trainable,
        name='simple_maze_3:reset_theta:trunc_8:vf_coef_01:sweep_outer_loss',
        config=config,
        resources_per_trial={
            'gpu': 0.5,
        },
