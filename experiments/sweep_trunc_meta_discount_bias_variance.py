...
if __name__ == '__main__':
    ...
    config = dict(
        ...
        truncation_length=tune.grid_search([2, 9, 16, 23, 30]),
        meta_discount=tune.grid_search([0.0, 0.5, 0.8, 0.9, 0.95, 1.0]),
    ...
    analysis = tune.run(
        trainable,
        name='on_policy_bandits:learn_lr_schedule:lt_len_30:noise_2:sweep_trunc:sweep_meta_discount:more_samples',
        config=config,
        verbose=1,
        resources_per_trial={
            'gpu': 0.2,
